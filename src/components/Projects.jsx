        ...
        <div className='h-full flex flex-col md:flex-row gap-5 justify-center relative'>
          <div className='flex flex-col gap-3 md:w-4/6'>
            ...
            <p className='text-base md:text-xl font-playfair'>
              ...
              proportions that devastated lives & shattered families.
            </p>
            {isShowMore && (
              <p className='text-base md:text-xl font-playfair'>
                The Windrush Warriors is a comedy drama that highlights the
                resilience of black people in a time of crisis. The show is a
                life-affirming view of a group of survivors who imagined a
                peaceful retirement but have to deal with a serious, unexpected
                challenge. And how do they cope with the stress and anxiety
                generated by the Conservative government’s hostile environment?
                By fighting back!
              </p>
            )}
            <button
